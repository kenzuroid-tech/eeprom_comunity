...
<head>
    ...
    <title>Voting Alumni — EEPROM POLINEMA</title>
    ...
    <style>
        ...
        body {
            ...
            background: #f0f2f5;
            background-image:
                radial-gradient(at 0% 0%, rgba(13, 71, 161, 0.1) 0px, transparent 50%),
                radial-gradient(at 100% 100%, rgba(255, 111, 0, 0.05) 0px, transparent 50%);
            min-height: 100vh;
            display: flex;
            align-items: center;
...
<body>
    <div class="login-card">
        ...
        <div class="p-4 p-md-5">
            ...
            <form action="/alumni/process-login" method="POST">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="graduation_year" class="form-control" placeholder="Contoh: 10" required>
                </div>
            ...
            <div class="info-box">
                <div class="d-flex align-items-start">
                    ...
                    <div>
                        ...
                        <p class="mb-0 text-muted small">Data Anda dienkripsi dan hanya digunakan untuk validasi kehadiran pemilih alumni secara anonim.</p>
                    </div>
                </div>
            </div>
