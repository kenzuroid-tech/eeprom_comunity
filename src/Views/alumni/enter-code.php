...
<head>
    ...
    <title>Verifikasi Kode Akses — EEPROM Voting Alumni</title>
    ...
    <style>
        ...
        body {
            ...
            background: #f0f2f5;
            background-image:
                radial-gradient(at 0% 0%, rgba(13, 71, 161, 0.15) 0px, transparent 50%),
                radial-gradient(at 100% 100%, rgba(25, 118, 210, 0.1) 0px, transparent 50%);
            min-height: 100vh;
            display: flex;
            align-items: center;
        ...
        .btn-verify:hover {
            ...
            box-shadow: 0 20px 25px -5px rgba(13, 71, 161, 0.4);
        }
...
<body>
        ...
        <div class="code-body">
            <div class="user-info-box">
                ...
                <div class="user-info-item">
                    ...
                    <span><?= htmlspecialchars($alumniData['name'] ?? '') ?></span>
                </div>
                <div class="user-info-item">
                    <i class="bi bi-credit-card-fill"></i>
                    <span><?= htmlspecialchars($alumniData['nim'] ?? '') ?></span>
                </div>
                <div class="user-info-item">
                    <i class="bi bi-calendar-check"></i>
                    <span>Lulus Tahun <?= htmlspecialchars($alumniData['graduation_year'] ?? '') ?></span>
                </div>
                <div class="user-info-item">
                    <i class="bi bi-book"></i>
                    <span><?= htmlspecialchars($alumniData['study_program'] ?? '') ?></span>
                </div>
            </div>
            ...
            <div class="alert alert-info d-flex align-items-center mb-3">
                ...
                <div>
                    ...
                    <code class="fs-5 fw-bold"><?= htmlspecialchars($_SESSION['alumni_temp_code'] ?? 'ERROR') ?></code>
                </div>
            </div>

            <form action="/alumni/verify-code" method="POST" id="codeForm">
                ...
                <div class="help-text">
                    ...
                    Format kode: <strong>VOTE-[XXX]-ALM-[XXXX]</strong><br>
                ...
                <a href="/alumni/back-to-login" class="btn btn-back">
    ...
    <script>
        ...
        document.getElementById('codeForm').addEventListener('submit', function(e) {
            ...
            if (code.length < 5) {
                e.preventDefault();
                alert('Kode akses terlalu pendek! Format: VOTE-XXX-ALM-XXXX');
                input.focus();
                return false;
            }
