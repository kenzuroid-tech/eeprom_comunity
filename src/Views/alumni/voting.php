        ...
        <div class="container">
            <div class="logo-section">
                ...
                <div>
                    ...
                    <small class="opacity-75">E-Voting Alumni</small>
                </div>
            </div>
            <div class="user-info">
                <div class="user-badge">
                    <i class="bi bi-mortarboard me-2"></i>
                    <?= htmlspecialchars($alumniName) ?>
                </div>
                <a href="/alumni/logout" class="btn btn-logout" onclick="return confirm('Yakin ingin logout?')">
    ...
    <div class="main-container">
        ...
        <?php if ($hasVoted): ?>
            <div class="voted-section">
                ...
                <hr class="my-4">
                <a href="/alumni/logout" class="btn btn-outline-primary btn-lg rounded-pill px-5">
        ...
        <?php else: ?>
            ...
            <form action="/alumni/submit-vote" method="POST" id="voteForm">
            ...
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-body text-center p-5">
                    ...
                    <div class="d-flex gap-3 justify-content-center">
                        ...
                        <button type="button" class="btn btn-primary btn-lg px-5 rounded-pill" onclick="submitVote()" style="background: linear-gradient(135deg, #0d47a1, #1976d2); border: none;">
