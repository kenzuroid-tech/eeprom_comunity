...
<head>
    ...
    <title>Detail Aktivitas - EEPROM POLINEMA</title>
    ...
    <style>
        /* ========================================
           CSS Variables (Sesuai index.html)
        ======================================== */
        :root {
            --primary-blue: #1A237E;
...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="/">
                <img src="/public/assets/images/eeprom logo.png" alt="Logo" width="45" class="me-2">
                <h1>EEPROM POLINEMA</h1>
            </a>
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item"><a class="nav-link" href="index.html">Home</a></li>
                    <li class="nav-item"><a class="nav-link active" href="activity.html">Activity</a></li>
                </ul>
            </div>
        </div>
    </nav>
    ...
    <footer class="footer mt-5">
        <div class="container text-center">
            <h4 class="fw-bold mb-3">EEPROM POLINEMA</h4>
            <p class="opacity-75">Inovasi Robotika untuk Masa Depan.</p>
            <div class="social-icons mb-4">
                <a href="#"><i class="fab fa-instagram"></i></a>
                <a href="#"><i class="fab fa-youtube"></i></a>
                <a href="#"><i class="fab fa-linkedin-in"></i></a>
            </div>
            <p class="small opacity-50 mb-0">&copy; 2024 EEPROM POLINEMA. All rights reserved.</p>
        </div>
    </footer>
    ...
    <script>
        ...
        // Simple Image Click Handler (Placeholder for Lightbox)
        document.querySelectorAll('.gallery-grid img').forEach(img => {
            img.addEventListener('click', () => {
                alert('Membuka gambar: ' + img.alt + '\n(Di sini Anda bisa mengintegrasikan Lighbox library)');
            });
        });
    </script>
</body>
