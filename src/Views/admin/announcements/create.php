...
<body>
        ...
        <div class="main-content-area">
            <div class="container-fluid p-4">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="/admin/announcements" class="btn btn-outline-secondary btn-sm"><i
                            ...
                            <div class="widget-card-admin bg-white p-4 rounded shadow-sm mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" class="form-control" rows="12"
                                        placeholder="Tulis konten pengumuman di sini..." required></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget-card-admin bg-white p-4 rounded shadow-sm">
                                ...
                                <div class="d-grid gap-2 mt-4">
                                    ...
                                    <button type="submit" name="status" value="draft"
                                        class="btn btn-light border fw-bold py-2">
    ...
    fileInput.addEventListener('change', function() {
        ...
        for (let i = 0; i < this.files.length; i++) {
            fileList.innerHTML +=
                `<div class="small text-primary"><i class="bi bi-file-earmark-check me-1"></i>${this.files[i].name}</div>`;
        }
    });
    </script>
